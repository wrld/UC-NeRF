import torch
import numpy as np
from network.renderer import ndc2dist
from torch import searchsorted
from kornia import create_meshgrid

from network.renderer import depth2dist
from utils.utils import index_point_feature



def get_ray_directions(H, W, intrinsic):
    """
    ...
    directions = torch.stack([(xs - intrinsic[0, 2]) / intrinsic[0, 0], (ys - intrinsic[1,2])/intrinsic[1,1], torch.ones_like(xs)], -1)  # (H, W, 3)
